...
Module['FS_createPath']("/", "sprites", true, true);
   ...
   loadPackage({"files": [{"filename": "/sounds/flip.wav", "start": 0, "end": 131200, "audio": 1}, {"filename": "/sounds/side_a.ogg", "start": 131200, "end": 4997418, "audio": 1}, {"filename": "/sprites/bg.png", "start": 4997418, "end": 5000179, "audio": 0}, {"filename": "/sprites/cursor_arrow.png", "start": 5000179, "end": 5000314, "audio": 0}, {"filename": "/sprites/letter_bottom.png", "start": 5000314, "end": 5001072, "audio": 0}, {"filename": "/sprites/letter_top.png", "start": 5001072, "end": 5001763, "audio": 0}], "remote_package_size": 5001763, "package_uuid": "ee404549-10ec-4df0-a688-e022f011a26f"});
...
var ASM_CONSTS = {
 ...
 243629: function($0) {return miniaudio.get_device_by_index($0).webaudio.sampleRate;},  
 243695: function($0) {var device = miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; if (device.intermediaryBuffer !== undefined) { Module._free(device.intermediaryBuffer); device.intermediaryBuffer = undefined; device.intermediaryBufferView = undefined; device.intermediaryBufferSizeInBytes = undefined; } miniaudio.untrack_device_by_index($0);},  
 244321: function($0) {var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = 2;},  
 244417: function($0) {var device = miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = 2;},  
 244513: function($0) {var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = 1;},  
 244610: function($0) {var device = miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = 1;}
};
...
/** @type {function(...*):?} */
var _ara_em_on_file_hover = Module["_ara_em_on_file_hover"] = createExportWrapper("ara_em_on_file_hover");
